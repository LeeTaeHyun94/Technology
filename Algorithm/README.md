...
![수식](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식.PNG)

이러한 동작 시간을 갖는 재귀적인 알고리즘이 있다고 하자. 이를 통해 Recursion Tree로 표현하게 되면

![트리](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\1.PNG)

이러한 Ternary Tree(삼원트리)로 표현할 수 있다. 그렇다면 전체 시간 복잡도는 트리의 높이(level)에 따라

- level 0
  - ![수식1](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식1.PNG)
- level 1
  - ![수식2](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식2.PNG)
- level k
  - ![수식3](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식3.PNG)

나타낼 수 있다. 그렇다면 아래 식처럼 변형이 가능하며

![수식4](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식4.PNG)

k를 극한까지 보내면 공비 r = 3/4 < 1

![수식5](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식5.PNG)

4로 수렴하는 것을 알 수 있다. 그러므로

![수식6](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식6.PNG)

따라서 재귀적 알고리즘의 시간 복잡도는 아래처럼 나타낼 수 있다.

![수식7](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식7.PNG)

이를 통해 알아낼 수 있는 것은 시간 복잡도의 지배(Domination)가 아래와 같다면

![수식8](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식8.PNG)

![수식9](C:\Users\Hyun\Desktop\workspace\Technology\Algorithm\수식9.PNG)
